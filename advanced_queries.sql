...
SELECT COUNT(*) FROM books JOIN authors ON books.author_id = authors.id WHERE nationality = 'United States of America';
...
SELECT * FROM books JOIN authors ON books.author_id = authors.id WHERE nationality != 'United States of America' AND publication_date < 1980;
...
SELECT * FROM books JOIN authors ON books.author_id = authors.id WHERE title LIKE 'N%';
